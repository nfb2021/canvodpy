...
-   :fontawesome-solid-sliders: &nbsp; **[Step 10](#10-configure-and-run)** &nbsp; Configuration + First run

    ---

    Initialize `canvod-settings.yaml` · Set paths and credentials · Validate · Process your first day
