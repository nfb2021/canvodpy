...
description: Install, configure, and run canVODpy entirely from the command line.
---
...
Want to drive this from Python instead — for scripting, notebooks, or a
custom pipeline? See the [Python Quickstart](python.md).
